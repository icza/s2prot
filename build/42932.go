...
typeinfos = [
    ...
    ('_array',[(0,9),6]),  #63
    ('_array',[(0,3),6]),  #64
    ('_struct',[[('m_control',10,-25),('m_userId',58,-24),('m_teamId',1,-23),('m_colorPref',60,-22),('m_racePref',44,-21),('m_difficulty',3,-20),('m_aiBuild',10,-19),('m_handicap',0,-18),('m_observe',24,-17),('m_logoIndex',6,-16),('m_hero',46,-15),('m_skin',46,-14),('m_mount',46,-13),('m_artifacts',61,-12),('m_workingSetSlotId',25,-11),('m_rewards',62,-10),('m_toonHandle',20,-9),('m_licenses',63,-8),('m_tandemLeaderId',58,-7),('m_commander',46,-6),('m_commanderLevel',6,-5),('m_hasSilencePenalty',13,-4),('m_tandemId',58,-3),('m_commanderMasteryLevel',6,-2),('m_commanderMasteryTalents',64,-1)]]),  #65
    ('_array',[(0,5),65]),  #66
    ('_struct',[[('m_phase',12,-11),('m_maxUsers',2,-10),('m_maxObservers',2,-9),('m_slots',66,-8),('m_randomSeed',6,-7),('m_hostUserId',58,-6),('m_isSinglePlayer',13,-5),('m_pickedMapTag',10,-4),('m_gameDuration',6,-3),('m_defaultDifficulty',3,-2),('m_defaultAIBuild',10,-1)]]),  #67
    ('_struct',[[('m_userInitialData',48,-3),('m_gameDescription',57,-2),('m_lobbyState',67,-1)]]),  #68
    ...
    ('_struct',[[('m_targetUnitFlags',79,-7),('m_timer',10,-6),('m_tag',6,-5),('m_snapshotUnitLink',79,-4),('m_snapshotControlPlayerId',58,-3),('m_snapshotUpkeepPlayerId',58,-2),('m_snapshotPoint',93,-1)]]),  #94
    ...
    ('_array',[(0,9),102]),  #103
    ('_struct',[[('m_subgroupIndex',98,-4),('m_removeMask',101,-3),('m_addSubgroups',103,-2),('m_addUnitTags',63,-1)]]),  #104
    ...
    ('_struct',[[('m_point',85,-9),('m_unit',6,-8),('m_unitLink',79,-7),('m_unitControlPlayerId',58,-6),('m_unitUpkeepPlayerId',58,-5),('m_unitPosition',93,-4),('m_unitIsUnderConstruction',13,-3),('m_pingedMinimap',13,-2),('m_option',84,-1)]]),  #117
    ...
    ('_struct',[[('m_decrementSeconds',84,-1)]]),  #165
    ...
    ('_int',[(-32768,16)]),  #170
    ('_struct',[[('m_wheelSpin',170,-2),('m_flags',112,-1)]]),  #171
    ('_struct',[[('m_purchaseCategoryId',84,-1)]]),  #172
    ('_struct',[[('m_button',79,-1)]]),  #173
    ('_struct',[[('m_cutsceneId',84,-2),('m_bookmarkName',20,-1)]]),  #174
    ('_struct',[[('m_cutsceneId',84,-1)]]),  #175
    ('_struct',[[('m_cutsceneId',84,-3),('m_conversationLine',20,-2),('m_altConversationLine',20,-1)]]),  #176
    ('_struct',[[('m_cutsceneId',84,-2),('m_conversationLine',20,-1)]]),  #177
    ('_struct',[[('m_leaveReason',1,-1)]]),  #178
    ('_struct',[[('m_observe',24,-7),('m_name',9,-6),('m_toonHandle',123,-5),('m_clanTag',41,-4),('m_clanLogo',42,-3),('m_hijack',13,-2),('m_hijackCloneGameUserId',58,-1)]]),  #179
    ('_optional',[96]),  #180
    ('_struct',[[('m_state',24,-2),('m_sequence',180,-1)]]),  #181
    ('_struct',[[('m_target',93,-1)]]),  #182
    ('_struct',[[('m_target',94,-1)]]),  #183
    ('_struct',[[('m_catalog',10,-4),('m_entry',79,-3),('m_field',9,-2),('m_value',9,-1)]]),  #184
    ('_struct',[[('m_index',6,-1)]]),  #185
    ('_struct',[[('m_shown',13,-1)]]),  #186
    ('_struct',[[('m_recipient',12,-2),('m_string',30,-1)]]),  #187
    ('_struct',[[('m_recipient',12,-2),('m_point',85,-1)]]),  #188
    ('_struct',[[('m_progress',84,-1)]]),  #189
    ...
    ('_struct',[[('m_playerId',1,0),('m_upgradeTypeName',29,1),('m_count',84,2)]]),  #197
