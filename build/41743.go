...
typeinfos = [
    ...
    ('_array',[(0,17),6]),  #62
    ('_array',[(0,9),6]),  #63
    ('_struct',[[('m_control',10,-23),('m_userId',58,-22),('m_teamId',1,-21),('m_colorPref',60,-20),('m_racePref',44,-19),('m_difficulty',3,-18),('m_aiBuild',10,-17),('m_handicap',0,-16),('m_observe',24,-15),('m_logoIndex',6,-14),('m_hero',46,-13),('m_skin',46,-12),('m_mount',46,-11),('m_artifacts',61,-10),('m_workingSetSlotId',25,-9),('m_rewards',62,-8),('m_toonHandle',20,-7),('m_licenses',63,-6),('m_tandemLeaderId',58,-5),('m_commander',46,-4),('m_commanderLevel',6,-3),('m_hasSilencePenalty',13,-2),('m_tandemId',58,-1)]]),  #64
    ('_array',[(0,5),64]),  #65
    ...
    ('_struct',[[('m_point',84,-9),('m_unit',6,-8),('m_unitLink',78,-7),('m_unitControlPlayerId',58,-6),('m_unitUpkeepPlayerId',58,-5),('m_unitPosition',92,-4),('m_unitIsUnderConstruction',13,-3),('m_pingedMinimap',13,-2),('m_option',83,-1)]]),  #116
    ...
    ('_struct',[[('m_decrementSeconds',83,-1)]]),  #164
    ('_struct',[[('m_portraitId',83,-1)]]),  #165
    ('_struct',[[('m_functionName',20,-1)]]),  #166
    ('_struct',[[('m_result',83,-1)]]),  #167
    ('_struct',[[('m_gameMenuItemIndex',83,-1)]]),  #168
    ('_int',[(-32768,16)]),  #169
    ('_struct',[[('m_wheelSpin',169,-2),('m_flags',111,-1)]]),  #170
    ('_struct',[[('m_purchaseCategoryId',83,-1)]]),  #171
    ('_struct',[[('m_button',78,-1)]]),  #172
    ('_struct',[[('m_cutsceneId',83,-2),('m_bookmarkName',20,-1)]]),  #173
    ('_struct',[[('m_cutsceneId',83,-1)]]),  #174
    ('_struct',[[('m_cutsceneId',83,-3),('m_conversationLine',20,-2),('m_altConversationLine',20,-1)]]),  #175
    ('_struct',[[('m_cutsceneId',83,-2),('m_conversationLine',20,-1)]]),  #176
    ('_struct',[[('m_leaveReason',1,-1)]]),  #177
    ('_struct',[[('m_observe',24,-7),('m_name',9,-6),('m_toonHandle',122,-5),('m_clanTag',41,-4),('m_clanLogo',42,-3),('m_hijack',13,-2),('m_hijackCloneGameUserId',58,-1)]]),  #178
    ('_optional',[95]),  #179
    ('_struct',[[('m_state',24,-2),('m_sequence',179,-1)]]),  #180
    ('_struct',[[('m_target',92,-1)]]),  #181
    ('_struct',[[('m_target',93,-1)]]),  #182
    ('_struct',[[('m_catalog',10,-4),('m_entry',78,-3),('m_field',9,-2),('m_value',9,-1)]]),  #183
    ('_struct',[[('m_index',6,-1)]]),  #184
    ('_struct',[[('m_shown',13,-1)]]),  #185
    ('_struct',[[('m_recipient',12,-2),('m_string',30,-1)]]),  #186
    ('_struct',[[('m_recipient',12,-2),('m_point',84,-1)]]),  #187
    ('_struct',[[('m_progress',83,-1)]]),  #188
    ('_struct',[[('m_status',24,-1)]]),  #189
    ...
    ('_struct',[[('m_playerId',1,0),('m_stats',190,1)]]),  #191
    ('_struct',[[('m_unitTagIndex',6,0),('m_unitTagRecycle',6,1),('m_unitTypeName',29,2),('m_controlPlayerId',1,3),('m_upkeepPlayerId',1,4),('m_x',10,5),('m_y',10,6)]]),  #192
    ('_struct',[[('m_unitTagIndex',6,0),('m_unitTagRecycle',6,1),('m_killerPlayerId',58,2),('m_x',10,3),('m_y',10,4),('m_killerUnitTagIndex',43,5),('m_killerUnitTagRecycle',43,6)]]),  #193
    ('_struct',[[('m_unitTagIndex',6,0),('m_unitTagRecycle',6,1),('m_controlPlayerId',1,2),('m_upkeepPlayerId',1,3)]]),  #194
    ('_struct',[[('m_unitTagIndex',6,0),('m_unitTagRecycle',6,1),('m_unitTypeName',29,2)]]),  #195
    ('_struct',[[('m_playerId',1,0),('m_upgradeTypeName',29,1),('m_count',83,2)]]),  #196
    ('_struct',[[('m_unitTagIndex',6,0),('m_unitTagRecycle',6,1)]]),  #197
    ('_array',[(0,10),83]),  #198
    ('_struct',[[('m_firstUnitIndex',6,0),('m_items',198,1)]]),  #199
    ('_struct',[[('m_playerId',1,0),('m_type',6,1),('m_userId',43,2),('m_slotId',43,3)]]),  #200
]
...
game_event_types = {
    ...
    67: (166, 'NNet.Game.STriggerMovieFunctionEvent'),
    ...
    88: (164, 'NNet.Game.SDecrementGameTimeRemainingEvent'),
    89: (165, 'NNet.Game.STriggerPortraitLoadedEvent'),
    90: (167, 'NNet.Game.STriggerCustomDialogDismissedEvent'),
    91: (168, 'NNet.Game.STriggerGameMenuItemSelectedEvent'),
    92: (170, 'NNet.Game.STriggerMouseWheelEvent'),
    93: (127, 'NNet.Game.STriggerPurchasePanelSelectedPurchaseItemChangedEvent'),
    94: (171, 'NNet.Game.STriggerPurchasePanelSelectedPurchaseCategoryChangedEvent'),
    95: (172, 'NNet.Game.STriggerButtonPressedEvent'),
    96: (77, 'NNet.Game.STriggerGameCreditsFinishedEvent'),
    97: (173, 'NNet.Game.STriggerCutsceneBookmarkFiredEvent'),
    98: (174, 'NNet.Game.STriggerCutsceneEndSceneFiredEvent'),
    99: (175, 'NNet.Game.STriggerCutsceneConversationLineEvent'),
    100: (176, 'NNet.Game.STriggerCutsceneConversationLineMissingEvent'),
    101: (177, 'NNet.Game.SGameUserLeaveEvent'),
    102: (178, 'NNet.Game.SGameUserJoinEvent'),
    103: (180, 'NNet.Game.SCommandManagerStateEvent'),
    104: (181, 'NNet.Game.SCmdUpdateTargetPointEvent'),
    ...
    109: (183, 'NNet.Game.SCatalogModifyEvent'),
    110: (184, 'NNet.Game.SHeroTalentTreeSelectedEvent'),
    111: (77, 'NNet.Game.STriggerProfilerLoggingFinishedEvent'),
    112: (185, 'NNet.Game.SHeroTalentTreeSelectionPanelToggledEvent'),
}
...
message_event_types = {
    0: (186, 'NNet.Game.SChatMessage'),
    1: (187, 'NNet.Game.SPingMessage'),
    2: (188, 'NNet.Game.SLoadingProgressMessage'),
    3: (77, 'NNet.Game.SServerPingMessage'),
    4: (189, 'NNet.Game.SReconnectNotifyMessage'),
}
...
tracker_event_types = {
    0: (191, 'NNet.Replay.Tracker.SPlayerStatsEvent'),
    1: (192, 'NNet.Replay.Tracker.SUnitBornEvent'),
    2: (193, 'NNet.Replay.Tracker.SUnitDiedEvent'),
    3: (194, 'NNet.Replay.Tracker.SUnitOwnerChangeEvent'),
    4: (195, 'NNet.Replay.Tracker.SUnitTypeChangeEvent'),
    5: (196, 'NNet.Replay.Tracker.SUpgradeEvent'),
    6: (192, 'NNet.Replay.Tracker.SUnitInitEvent'),
    7: (197, 'NNet.Replay.Tracker.SUnitDoneEvent'),
    8: (199, 'NNet.Replay.Tracker.SUnitPositionsEvent'),
    9: (200, 'NNet.Replay.Tracker.SPlayerSetupEvent'),
}
